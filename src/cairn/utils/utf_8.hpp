...
template<typename CharType, typename Iter, std::output_iterator<CharType> OutIter>
...
inline std::size_t decodeUtf16UnknownOrder(std::size_t a, std::size_t b)
{
...
template<typename Iter, std::output_iterator<char8_t> OutIter>
