export module cairn.module_type;

import <string_view>;

export enum class ModuleType {
    ///Interface module
    /**
...
export constexpr std::string_view to_string(ModuleType t) {
    switch (t) {
...
export constexpr bool generates_bmi(ModuleType t) {
    return t == ModuleType::user_header
        || t == ModuleType::system_header
        || t == ModuleType::partition
        || t == ModuleType::interface;
}
export constexpr bool generates_object(ModuleType t) {
    return t == ModuleType::implementation
        || t == ModuleType::source
        || t == ModuleType::interface
        || t == ModuleType::partition;
}
export constexpr bool is_header_module(ModuleType t) {
