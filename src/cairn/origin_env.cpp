export module cairn.origin_env;

import <filesystem>;
import <vector>;

export struct ModuleMapItem {
    std::string prefix;
...
export using ModuleMap = std::vector<ModuleMapItem>;

export struct OriginEnv {
...
export using POriginEnv = std::shared_ptr<OriginEnv>;